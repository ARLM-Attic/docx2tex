...
\frac{1}{400},\frac{3}{400} ,, \frac{4001}{400}\rbrace $
. The distributions of phenotypes currently under selection are 
described by $p_{y,y,t}$. After selection, these distributions 
were re-weighted by their phenotype-specific viability, 
...
\equiv for allcomplement partialdiff\sqrt{\sqrt[3]{\sqrt[4]{
a}}}unionints\emptyset \%degdegFdegC\Delta triangledown \exists 
nexists \ni \ni \gets \uparrow \to \downarrow \leftrightarrow \pm \alpha 
\beta \gamma \delta \epsilon E\theta \vartheta \mu \pi \rho \sigma \tau 
\phi \omega \cdot $\\
