...
converted to TeX mathematical formulas and Fig respectively. Both of 
them is described in XML format therefore our standard solution, XSL 
transformations can be used.

\section{A Complex Example}
In this section we will show a complex example broken into parts that 
can show the most important features of docx2tex.

\subsection{The Structure of the OOXML Zip Package}
First unzip the contents of our OOXML Word 2007 document to a directory 
and get a directory listing recursively:
...
The text in document.xml is grouped in paragraphs. Every segment of the 
document is a paragraph (normal text, heading texts, images, etc.) 
except for some special elements like tables.
